...
###### Прм исполнениии скрипта в операционной системе Windows рекомендуется использовать ключ -X utf8  
###### при запуске скрипта из командной строки (python -X utf8 seaf2drawio.py) либо переменную окружения set PYTHONUTF8=1
